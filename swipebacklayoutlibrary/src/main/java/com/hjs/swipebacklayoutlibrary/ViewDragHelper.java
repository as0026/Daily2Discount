...
package com.hjs.swipebacklayoutlibrary;
...
public class ViewDragHelper {
     ...
     * callback's
     * {@link com.hjs.swipebacklayoutlibrary.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link com.hjs.swipebacklayoutlibrary.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
     ...
     * {@link com.hjs.swipebacklayoutlibrary.ViewDragHelper.Callback#tryCaptureView(View, int)}
     ...
     * {@link com.hjs.swipebacklayoutlibrary.ViewDragHelper.Callback#getOrderedChildIndex(int)}
     * .
     *
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system
